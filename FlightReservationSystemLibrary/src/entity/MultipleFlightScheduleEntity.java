...
public class MultipleFlightScheduleEntity extends FlightSchedulePlanEntity implements Serializable {
    ...
    public MultipleFlightScheduleEntity(String flightNumber, List<FlightScheduleEntity> listOfFlightSchedule, FlightSchedulePlanEntity returnFlightSchedulePlan, List<Fare> listOfFare, boolean isDeleted) {
