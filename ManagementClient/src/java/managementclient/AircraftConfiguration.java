...
public class AircraftConfiguration {
    ...
    public void createAircraftConfiguration() {
        try {
            ...
            List<AircraftTypeEntity> listOfAircraftType = aircraftSessionBeanRemote.getAircraftTypes();
            System.out.printf("%-40s%-30s", "Aircraft Type ID", "Aircraft Type");
            System.out.println();

            for (AircraftTypeEntity ac : listOfAircraftType) {
                System.out.printf("%-40s%-30s", ac.getAircraftTypeId(), ac.getAircraftTypeName());
                System.out.println();
            }
            System.out.println();
            System.out.print("Please enter the ID for aircraft type:  ");
            Long aircraftTypeId = sc.nextLong();
            sc.nextLine();
            
            AircraftTypeEntity aircraftType = aircraftSessionBeanRemote.getAircraftType(aircraftTypeId);
            ...
            Set<ConstraintViolation<AircraftTypeEntity>> constraintViolationsAircraftType = validator.validate(aircraftType);
            ...
            if (isValidationPassed) {
                ...
                if (addRecordToDatabase) {
                    Long id = aircraftSessionBeanRemote.createAircraftConfiguration(aircraftConfigurationEntity, aircraftType, listOfCabin);
